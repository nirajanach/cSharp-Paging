...
{//this is chainable LINQ extension method
    ...
    //these are scaler LINQ extension methods
    ...
    public static decimal? Median<T> (this 
        IEnumerable<T> sequence, Func<T, decimal> selector)
    {
        return sequence.Select(selector).Median();
    }
